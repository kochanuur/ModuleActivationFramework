...
{
    internal class TokyoDisneySeaManager : ITokyoDisneySeaManager
    {
        private const string THEME_PARK_NAME_API = "Walt Disney Attractions:Tokyo DisneySea";

        private List<IService> moduleList;
        private int themeParkId = -1;
        private bool isIdRetrieved = false;

        public TokyoDisneySeaManager()
        {
